...
object UtSettings : AbstractSettings(
    ...
    * */
    ...
    /**
     * Fuzzer uses own minimization
     */
    var fuzzingMinimization: Boolean by getBooleanProperty(true)

    /**
     * Total limit on test which are generated by fuzzer
     */
    var fuzzingTotalLimit: Int by getIntProperty(Int.MAX_VALUE)
