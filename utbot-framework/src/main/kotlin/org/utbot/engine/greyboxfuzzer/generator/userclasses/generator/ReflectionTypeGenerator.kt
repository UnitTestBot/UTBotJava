...
class ReflectionTypeGenerator(
    ...
    override fun generate(): UtModel {
        ...
        if (Random.getTrue(70) && randomTypeFromMethod != null) {
            return generatorContext.utModelConstructor.construct(randomTypeFromMethod, Type::class.java.id)
        }
