...
internal abstract class TestFrameworkManager(val context: CgContext)
    ...
    open fun getDeepEqualsAssertion(expected: CgExpression, actual: CgExpression): CgMethodCall {
        requiredUtilMethods += outerMostTestClass.deepEqualsMethodId.asExecutableMethod()
        requiredUtilMethods += outerMostTestClass.arraysDeepEqualsMethodId.asExecutableMethod()
        requiredUtilMethods += outerMostTestClass.iterablesDeepEqualsMethodId.asExecutableMethod()
        requiredUtilMethods += outerMostTestClass.streamsDeepEqualsMethodId.asExecutableMethod()
        requiredUtilMethods += outerMostTestClass.mapsDeepEqualsMethodId.asExecutableMethod()
        requiredUtilMethods += outerMostTestClass.hasCustomEqualsMethodId.asExecutableMethod()
