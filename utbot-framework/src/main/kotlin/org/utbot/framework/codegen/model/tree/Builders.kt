...
class CgTestClassBodyBuilder : CgBuilder<CgTestClassBody> {
    ...
    val nestedClassesRegion: MutableList<CgRegion<CgTestClass>> = mutableListOf()

    override fun build() = CgTestClassBody(testMethodRegions, dataProvidersAndUtilMethodsRegion, nestedClassesRegion)
}
