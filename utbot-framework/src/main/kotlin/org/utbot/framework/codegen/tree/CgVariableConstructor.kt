...
open class CgVariableConstructor(val context: CgContext) :
    ...
    open val mockFrameworkManager = getMockFrameworkManagerBy(context)
    ...
    open fun setFieldValue(obj: CgValue, fieldId: FieldId, variableForField: CgValue){
    ...
    open fun constructAssembleForVariable(model: UtAssembleModel): CgValue {
