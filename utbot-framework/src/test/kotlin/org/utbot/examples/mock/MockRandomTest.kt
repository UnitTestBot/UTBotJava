...
import org.utbot.examples.mockValues
import org.utbot.examples.mocksMethod
...
internal class MockRandomTest : UtTestCaseChecker(testClass = MockRandomExamples::class) {
    @Test
