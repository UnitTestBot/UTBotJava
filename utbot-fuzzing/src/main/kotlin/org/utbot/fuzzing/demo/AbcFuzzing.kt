...
suspend fun main() {
    ...
    object : Fuzzing<Unit, String, Description<Unit>, BaseFeedback<Int, Unit, String>> {
        /**
         ...
         */
        override fun generate(description: Description<Unit>, type: Unit) = sequenceOf<Seed<Unit, String>>(
