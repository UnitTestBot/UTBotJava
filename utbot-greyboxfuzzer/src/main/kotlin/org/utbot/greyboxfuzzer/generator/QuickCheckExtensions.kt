...
import org.utbot.greyboxfuzzer.quickcheck.internal.FakeAnnotatedTypeFactory
import org.utbot.greyboxfuzzer.quickcheck.internal.ParameterTypeContext
import org.utbot.greyboxfuzzer.quickcheck.internal.generator.ArrayGenerator
import org.utbot.greyboxfuzzer.quickcheck.internal.generator.CompositeGenerator
import org.utbot.greyboxfuzzer.quickcheck.internal.generator.GeneratorRepository
...
fun Generator.getComponents(): List<Generator> =
    when (this) {
        is org.utbot.greyboxfuzzer.quickcheck.generator.ComponentizedGenerator -> this.componentGenerators()
