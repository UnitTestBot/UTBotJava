package org.utbot.greyboxfuzzer.quickcheck
...
class NonTrackingGenerationStatus(private val random: SourceOfRandomness) : GenerationStatus {
    ...
    override fun size(): Int {
        return geometric.sampleWithMean(org.utbot.greyboxfuzzer.quickcheck.NonTrackingGenerationStatus.Companion.MEAN_SIZE.toDouble(), random)
    }
