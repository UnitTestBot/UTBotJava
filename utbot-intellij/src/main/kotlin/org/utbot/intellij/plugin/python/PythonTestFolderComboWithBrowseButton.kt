...
// This is very similar to TestFolderComboWithBrowseButton !
class PythonTestFolderComboWithBrowseButton(private val model: PythonTestsModel) : ComboboxWithBrowseButton() {
    ...
    private fun createNewTestSourceRoot(model: PythonTestsModel): VirtualFile? =
    ...
    private fun formatUrl(virtualFile: VirtualFile, model: PythonTestsModel): String {
