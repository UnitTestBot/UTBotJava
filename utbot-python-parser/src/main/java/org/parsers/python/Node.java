...
public interface Node extends Comparable<Node>  {
    ...
    default String getInputSource() {
        ...
        return tokenSource== null?"input":
        tokenSource.getInputSource();
    }
    ...
    /**
      * @return the #PythonLexer from which this Node object
      ...
      * machinery.
      */
    PythonLexer getTokenSource();
    void setTokenSource(PythonLexer tokenSource);
    /**
      * @return the original source content this Node came from
      * a reference to the #PythonLexer that stores the source code and
    ...
    default String getSource() {
        PythonLexer tokenSource= getTokenSource();
        return tokenSource== null?null:
        tokenSource.getText(getBeginOffset(), getEndOffset());
    }
    ...
    default int getBeginLine() {
        PythonLexer tokenSource= getTokenSource();
        return tokenSource== null?0:
        tokenSource.getLineFromOffset(getBeginOffset());
    }
    ...
    default int getEndLine() {
        PythonLexer tokenSource= getTokenSource();
        return tokenSource== null?0:
        tokenSource.getLineFromOffset(getEndOffset()-1);
    }
    ...
    default int getBeginColumn() {
        PythonLexer tokenSource= getTokenSource();
        return tokenSource== null?0:
        tokenSource.getCodePointColumnFromOffset(getBeginOffset());
    }
    ...
    default int getEndColumn() {
        PythonLexer tokenSource= getTokenSource();
        return tokenSource== null?0:
        tokenSource.getCodePointColumnFromOffset(getEndOffset()-1);
    }
    ...
    default Token firstDescendantOfType(PythonConstants.TokenType type) {
        for (int i= 0; i<getChildCount(); i++) {
            Node child= getChild(i);
            if (child instanceof Token) {
                Token tok= (Token) child;
    ...
    default Token firstChildOfType(PythonConstants.TokenType tokenType) {
        for (int i= 0; i<getChildCount(); i++) {
            Node child= getChild(i);
            if (child instanceof Token) {
                Token tok= (Token) child;
    ...
    default PythonConstants.TokenType getTokenType() {
        return this instanceof Token?((Token) this).getType():
        null;
    }
