...
public class ArraysQuickSort {
    // a with size >= 3 require greater step limit. For five elements more than 5000 (maybe a lot more)
    public static int[] runDefaultQuickSort(int value) {
        int[] a = {value + 100, value};
    ...
    public static void sort(int[] a, int left, int right,
         ...
         */
        int[] run = new int[67 + 1]; // MAX_RUN_COUNT
        int count = 0;
        run[0] = left;
    ...
    private static void internalSort(int[] a, int left, int right, boolean leftmost) {
        ...
        if (length < 47) { // INSERTION_SORT_THRESHOLD
            if (leftmost) {
                /*
