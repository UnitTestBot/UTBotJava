package org.utbot.language.ts.framework.codegen.model.constructor.visitor
...
//        throw Exception("TypeCast not yet implemented")
    ...
    override fun visit(element: CgMethodCall) {
        ...
        if (element.type.name == "error") {
            print("(")
            element.arguments[0].accept(this@CgTsRenderer)
            print(", ")
            print("Error, ")
            element.arguments[2].accept(this@CgTsRenderer)
            print(")")
        } else {
    ...
    override fun renderForLoopVarControl(element: CgForLoop) {
        ...
        with(element.initialization) {
            ...
            visit(variable)
            print(" = ")
            initializer?.accept(this@CgTsRenderer)
            print("; ")
